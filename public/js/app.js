...
var CommentCaMarche = function () {
	function CommentCaMarche() {
		_classCallCheck(this, CommentCaMarche);
	}

	_createClass(CommentCaMarche, [{
		key: "construct",
...
var myCommentCaMarche = new CommentCaMarche();
$(function () {
	if (myCommentCaMarche.Page.attr("data-page") === "HowIsWorks") {
		var setClassActive = function setClassActive(parent, child) {
